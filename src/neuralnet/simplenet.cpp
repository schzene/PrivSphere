...
SimpleNetBlock::SimpleNetBlock(unsigned int _party, size_t num_feature, size_t comm_dim,
                               size_t output_dim)
    : party(_party) {
...
SimpleNet::SimpleNet(unsigned int party, unsigned num_feature, unsigned comm_dim,
                     unsigned output_dim) {
