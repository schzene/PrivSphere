...
namespace seal_bs {
    ...
    */
    class Evaluator : public seal::Evaluator
    {
    public:
        /**
        ...
        */
        Evaluator(const seal::SEALContext &context, seal::CKKSEncoder &encoder);
        ...
        parameters
        */
        void negate_inplace(seal::Ciphertext &encrypted) const;
        ...
        */
        inline void negate(const seal::Ciphertext &encrypted, seal::Ciphertext &destination) const
        {
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void add_inplace(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2) const;
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void add(const seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, seal::Ciphertext &destination) const
        {
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void add_many(const std::vector<seal::Ciphertext> &encrypteds, seal::Ciphertext &destination) const;
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void sub_inplace(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2) const;
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void sub(const seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, seal::Ciphertext &destination) const
        {
            if (&encrypted2 == &destination)
            {
        ...
        */
        void multiply_inplace(
            seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2,
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void square_inplace(seal::Ciphertext &encrypted, seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const;
        ...
        */
        inline void square(
            const seal::Ciphertext &encrypted, seal::Ciphertext &destination,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
            destination = encrypted;
        ...
        */
        inline void relinearize_inplace(
            seal::Ciphertext &encrypted, const seal::RelinKeys &relin_keys, seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
        ...
        */
        inline void relinearize(
            const seal::Ciphertext &encrypted, const seal::RelinKeys &relin_keys, seal::Ciphertext &destination,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
            destination = encrypted;
        ...
        */
        inline void mod_switch_to_next_inplace(
            seal::Ciphertext &encrypted, seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
        ...
        */
        void mod_switch_to_inplace(
            seal::Ciphertext &encrypted, seal::parms_id_type parms_id, seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const;
        ...
        */
        inline void mod_switch_to(
            const seal::Ciphertext &encrypted, seal::parms_id_type parms_id, seal::Ciphertext &destination,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
            destination = encrypted;
        ...
        @throws std::invalid_argument if the scale is too large for the new encryption parameters
        */
        inline void mod_switch_to_next_inplace(seal::Plaintext &plain) const
        {
            // Verify parameters.
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        inline void mod_switch_to_next(const seal::Plaintext &plain, seal::Plaintext &destination) const
        {
            destination = plain;
        ...
        @throws std::invalid_argument if the scale is too large for the new encryption parameters
        */
        void mod_switch_to_inplace(seal::Plaintext &plain, seal::parms_id_type parms_id) const;
        ...
        @throws std::invalid_argument if the scale is too large for the new encryption parameters
        */
        inline void mod_switch_to(const seal::Plaintext &plain, seal::parms_id_type parms_id, seal::Plaintext &destination) const
        {
            destination = plain;
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void mod_reduce_to_next_inplace(seal::Ciphertext &encrypted, seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const;
        ...
        */
        void multiply_many(
            const std::vector<seal::Ciphertext> &encrypteds, const seal::RelinKeys &relin_keys, seal::Ciphertext &destination,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const;
        ...
        */
        void exponentiate_inplace(
            seal::Ciphertext &encrypted, std::uint64_t exponent, const seal::RelinKeys &relin_keys,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const;
        ...
        */
        inline void exponentiate(
            const seal::Ciphertext &encrypted, std::uint64_t exponent, const seal::RelinKeys &relin_keys, seal::Ciphertext &destination,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
            destination = encrypted;
        ...
        */
        void add_plain_inplace(
            seal::Ciphertext &encrypted, const seal::Plaintext &plain, seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const;
        ...
        */
        void transform_to_ntt_inplace(
            seal::Plaintext &plain, seal::parms_id_type parms_id, seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const;
        ...
        */
        inline void transform_to_ntt(
            const seal::Plaintext &plain, seal::parms_id_type parms_id, seal::Plaintext &destination_ntt,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void transform_to_ntt_inplace(seal::Ciphertext &encrypted) const;
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void transform_to_ntt(const seal::Ciphertext &encrypted, seal::Ciphertext &destination_ntt) const
        {
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void transform_from_ntt_inplace(seal::Ciphertext &encrypted_ntt) const;
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void transform_from_ntt(const seal::Ciphertext &encrypted_ntt, seal::Ciphertext &destination) const
        {
        ...
        */
        void apply_galois_inplace(
            seal::Ciphertext &encrypted, std::uint32_t galois_elt, const seal::GaloisKeys &galois_keys,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const;
        ...
        */
        inline void apply_galois(
            const seal::Ciphertext &encrypted, std::uint32_t galois_elt, const seal::GaloisKeys &galois_keys,
        ...
        */
        inline void rotate_rows_inplace(
            seal::Ciphertext &encrypted, int steps, const seal::GaloisKeys &galois_keys,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
        ...
        */
        inline void rotate_rows(
            const seal::Ciphertext &encrypted, int steps, const seal::GaloisKeys &galois_keys, seal::Ciphertext &destination,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
            destination = encrypted;
        ...
        */
        inline void rotate_columns_inplace(
            seal::Ciphertext &encrypted, const seal::GaloisKeys &galois_keys,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
            auto scheme = context_.key_context_data()->parms().scheme();
            if (scheme != seal::scheme_type::bfv && scheme != seal::scheme_type::bgv)
        ...
        */
        inline void rotate_columns(
            const seal::Ciphertext &encrypted, const seal::GaloisKeys &galois_keys, seal::Ciphertext &destination,
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
            destination = encrypted;
        ...
        */
        inline void rotate_vector_inplace(
            ...
            seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const
        {
            if (context_.key_context_data()->parms().scheme() != seal::scheme_type::ckks)
            {
                throw std::logic_error("unsupported scheme");
            }
            rotate_internal(encrypted, steps, galois_keys, std::move(pool));
        ...
        */
        void add_const_inplace(seal::Ciphertext &encrypted, double value) const;

        inline void add_const(const seal::Ciphertext &encrypted, double value, seal::Ciphertext &destination) const{
            destination = encrypted;
            add_const_inplace(destination, value);
        }

        void multiply_const_inplace(seal::Ciphertext &encrypted, double value) const;

        inline void multiply_const(const seal::Ciphertext &encrypted, double value, seal::Ciphertext &destination) const {
            destination = encrypted;
            multiply_const_inplace(destination, value);
        }

        template <typename T>
        void multiply_vector_inplace(seal::Ciphertext &encrypted, const std::vector<T> &value) const;

        template <typename T>
        void multiply_vector(seal::Ciphertext &encrypted, const std::vector<T> &value, seal::Ciphertext &destination) const {
            destination = encrypted;
        ...
        */
        ...
        void add_inplace_reduced_error(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2) const;

        inline void add_reduced_error(const seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, seal::Ciphertext &destination) const
        {
            if (&encrypted2 == &destination)
            {
        ...
        inline void double_inplace(seal::Ciphertext & encrypted) const {
            add_inplace(encrypted, encrypted);
        }

        void sub_inplace_reduced_error(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2)  const;

        inline void sub_reduced_error(const seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, seal::Ciphertext &destination) const
        {
            destination = encrypted1;
            sub_inplace_reduced_error(destination, encrypted2);
        }

        void multiply_inplace_reduced_error(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, const seal::RelinKeys &relin_keys) const;

        inline void multiply_reduced_error(const seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, const seal::RelinKeys &relin_keys, seal::Ciphertext &destination) const
        {
            if (&encrypted2 == &destination)
            {
		...
		void multiply_vector_inplace_reduced_error(seal::Ciphertext &encrypted, const std::vector<T> &value)
		{
		...
		template <typename T, typename = std::enable_if_t<std::is_same<std::remove_cv_t<T>, double>::value ||std::is_same<std::remove_cv_t<T>, std::complex<double>>::value>>
		inline void multiply_vector_reduced_error(seal::Ciphertext &encrypted, const std::vector<T> &value, seal::Ciphertext &destination)
		{
			destination = encrypted;
    ...
    private:
        ...
        void bfv_multiply(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, seal::MemoryPoolHandle pool) const;

        void ckks_multiply(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, seal::MemoryPoolHandle pool) const;

        void bgv_multiply(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, seal::MemoryPoolHandle pool) const;

        void bfv_square(seal::Ciphertext &encrypted, seal::MemoryPoolHandle pool) const;

        void ckks_square(seal::Ciphertext &encrypted, seal::MemoryPoolHandle pool) const;

        void bgv_square(seal::Ciphertext &encrypted, seal::MemoryPoolHandle pool) const;

        void relinearize_internal(
            seal::Ciphertext &encrypted, const seal::RelinKeys &relin_keys, std::size_t destination_size,
            seal::MemoryPoolHandle pool) const;

        void mod_switch_scale_to_next(
            const seal::Ciphertext &encrypted, seal::Ciphertext &destination, seal::MemoryPoolHandle pool) const;

        void mod_switch_drop_to_next(const seal::Ciphertext &encrypted, seal::Ciphertext &destination, seal::MemoryPoolHandle pool) const;

        void mod_switch_drop_to_next(seal::Plaintext &plain) const;

        void rotate_internal(
            seal::Ciphertext &encrypted, int steps, const seal::GaloisKeys &galois_keys, seal::MemoryPoolHandle pool) const;

        inline void conjugate_internal(
            seal::Ciphertext &encrypted, const seal::GaloisKeys &galois_keys, seal::MemoryPoolHandle pool) const
        {
            // Verify parameters.
        ...
        void switch_key_inplace(
            ...
            std::size_t key_index, seal::MemoryPoolHandle pool = seal::MemoryManager::GetPool()) const;

        void multiply_plain_normal(seal::Ciphertext &encrypted, const seal::Plaintext &plain, seal::MemoryPoolHandle pool) const;

        void multiply_plain_ntt(seal::Ciphertext &encrypted_ntt, const seal::Plaintext &plain_ntt) const;
