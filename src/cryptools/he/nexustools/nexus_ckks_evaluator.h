...
public:
    ...
    CKKSEvaluator(SEALContext& context, Encryptor& encryptor, Decryptor& decryptor, CKKSEncoder& encoder,
                  Evaluator& evaluator, double scale, RelinKeys& relin_keys, GaloisKeys& galois_keys) {
        this->scale       = scale;
