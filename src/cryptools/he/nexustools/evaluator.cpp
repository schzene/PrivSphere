...
namespace seal_bs {
    namespace
    {
        ...
        */
        SEAL_NODISCARD inline auto balance_correction_factors(
            uint64_t factor1, uint64_t factor2, const seal::Modulus &plain_modulus) -> tuple<uint64_t, uint64_t, uint64_t>
        {
    ...
    Evaluator::Evaluator(const seal::SEALContext &context, seal::CKKSEncoder &encoder) : context_(context), encoder_(encoder), seal::Evaluator(context_)
    {   
        // Verify parameters
    ...
    void Evaluator::negate_inplace(seal::Ciphertext &encrypted) const
    {
        // Verify parameters.
    ...
    void Evaluator::add_inplace(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2) const
    {
        // Verify parameters.
        ...
        if (encrypted1.correction_factor() != encrypted2.correction_factor())
        {
            ...
            seal::Ciphertext encrypted2_copy = encrypted2;
            multiply_poly_scalar_coeffmod(
    ...
    void Evaluator::add_many(const vector<seal::Ciphertext> &encrypteds, seal::Ciphertext &destination) const
    {
        if (encrypteds.empty())
        {
    ...
    void Evaluator::sub_inplace(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2) const
    {
        // Verify parameters.
        if (!is_metadata_valid_for(encrypted1, context_) || !is_buffer_valid(encrypted1))
        {
    ...
    void Evaluator::multiply_inplace(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        if (!is_metadata_valid_for(encrypted1, context_) || !is_buffer_valid(encrypted1))
        {
    ...
    void Evaluator::add_const_inplace(seal::Ciphertext &encrypted, double value) const {
        seal::Plaintext const_plain;

        encoder_.encode(value, encrypted.scale(), const_plain);
        mod_switch_to_inplace(const_plain, encrypted.parms_id());
        add_plain_inplace(encrypted, const_plain);
    }

    void Evaluator::multiply_const_inplace(seal::Ciphertext &encrypted, double value) const{
        seal::Plaintext const_plain;

        encoder_.encode(value, encrypted.scale(), const_plain);
        mod_switch_to_inplace(const_plain, encrypted.parms_id());
        multiply_plain_inplace(encrypted, const_plain);
    }

    template <typename T>
    void Evaluator::multiply_vector_inplace(seal::Ciphertext &encrypted, const std::vector<T> &value) const {
        seal::Plaintext vector_plain;

        encoder_.encode(value, encrypted.scale(), vector_plain);
        mod_switch_to_inplace(vector_plain, encrypted.parms_id());
        multiply_plain_inplace(encrypted, vector_plain);
    }

    void Evaluator::add_inplace_reduced_error(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2) const {
        ...
        else if(encrypted1_coeff_modulus_size < encrypted2_coeff_modulus_size)
        {
            ...
            seal::Ciphertext encrypted2_adjusted;
        ...
        else
        {
            ...
            auto &parms = context_data.parms();
            auto modulus = iter(parms.coeff_modulus());
            seal::Ciphertext encrypted1_adjusted;
    ...
    void Evaluator::sub_inplace_reduced_error(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2) const {
        size_t encrypted1_coeff_modulus_size = encrypted1.coeff_modulus_size();
        size_t encrypted2_coeff_modulus_size = encrypted2.coeff_modulus_size();
    ...
    void Evaluator::multiply_inplace_reduced_error(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, const seal::RelinKeys &relin_keys) const {
        size_t encrypted1_coeff_modulus_size = encrypted1.coeff_modulus_size();
        size_t encrypted2_coeff_modulus_size = encrypted2.coeff_modulus_size();
    ...
    void Evaluator::bfv_multiply(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, seal::MemoryPoolHandle pool) const
    {
        if (encrypted1.is_ntt_form() || encrypted2.is_ntt_form())
        {
    ...
    void Evaluator::ckks_multiply(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, seal::MemoryPoolHandle pool) const
    {
        if (!(encrypted1.is_ntt_form() && encrypted2.is_ntt_form()))
        {
    ...
    void Evaluator::bgv_multiply(seal::Ciphertext &encrypted1, const seal::Ciphertext &encrypted2, seal::MemoryPoolHandle pool) const
    {
        if (!encrypted1.is_ntt_form() || !encrypted2.is_ntt_form())
        {
            throw invalid_argument("encrypted1 or encrypted2 must be in NTT form");
    ...
    void Evaluator::square_inplace(seal::Ciphertext &encrypted, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        if (!is_metadata_valid_for(encrypted, context_) || !is_buffer_valid(encrypted))
        {
    ...
    void Evaluator::bfv_square(seal::Ciphertext &encrypted, seal::MemoryPoolHandle pool) const
    {
    ...
    void Evaluator::ckks_square(seal::Ciphertext &encrypted, seal::MemoryPoolHandle pool) const
    {
        if (!encrypted.is_ntt_form())
        {
    ...
    void Evaluator::bgv_square(seal::Ciphertext &encrypted, seal::MemoryPoolHandle pool) const
    {
        if (!encrypted.is_ntt_form())
        {
            throw invalid_argument("encrypted must be in NTT form");
    ...
    void Evaluator::relinearize_internal(
        seal::Ciphertext &encrypted, const seal::RelinKeys &relin_keys, size_t destination_size, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        ...
        SEAL_ITERATE(iter(size_t(0)), relins_needed, [&](auto I) {
            this->switch_key_inplace(
                encrypted, *encrypted_iter, static_cast<const seal::KSwitchKeys &>(relin_keys),
                seal::RelinKeys::get_index(encrypted_size - 1 - I), pool);
        });
        ...
        const seal::Ciphertext &encrypted, seal::Ciphertext &destination, seal::MemoryPoolHandle pool) const
    {
        ...
        auto context_data_ptr = context_.get_context_data(encrypted.parms_id());
        if (context_data_ptr->parms().scheme() == seal::scheme_type::bfv && encrypted.is_ntt_form())
        {
        ...
        if (context_data_ptr->parms().scheme() == seal::scheme_type::bgv && !encrypted.is_ntt_form())
        {
        ...
        seal::Ciphertext encrypted_copy(pool);
    ...
    void Evaluator::mod_switch_drop_to_next(seal::Plaintext &plain) const
    {
    ...
    void Evaluator::mod_switch_to_inplace(seal::Ciphertext &encrypted, seal::parms_id_type parms_id, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        auto context_data_ptr = context_.get_context_data(encrypted.parms_id());
    ...
    void Evaluator::mod_switch_to_inplace(seal::Plaintext &plain, seal::parms_id_type parms_id) const
    {
        // Verify parameters.
        auto context_data_ptr = context_.get_context_data(plain.parms_id());
        auto target_context_data_ptr = context_.get_context_data(parms_id);
    ...
    void Evaluator::rescale_to_next(const seal::Ciphertext &encrypted, seal::Ciphertext &destination, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        if (!is_metadata_valid_for(encrypted, context_) || !is_buffer_valid(encrypted))
        {
    ...
    void Evaluator::rescale_to_inplace(seal::Ciphertext &encrypted, seal::parms_id_type parms_id, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        if (!is_metadata_valid_for(encrypted, context_) || !is_buffer_valid(encrypted))
        {
    ...
    void Evaluator::mod_reduce_to_next_inplace(seal::Ciphertext &encrypted, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        if (!is_metadata_valid_for(encrypted, context_) || !is_buffer_valid(encrypted))
        {
    ...
    void Evaluator::mod_reduce_to_inplace(seal::Ciphertext &encrypted, seal::parms_id_type parms_id, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        auto context_data_ptr = context_.get_context_data(encrypted.parms_id());
        auto target_context_data_ptr = context_.get_context_data(parms_id);
    ...
    void Evaluator::multiply_many(
        const vector<seal::Ciphertext> &encrypteds, const seal::RelinKeys &relin_keys, seal::Ciphertext &destination,
        seal::MemoryPoolHandle pool) const
    {
        ...
        if (parms.scheme() != seal::scheme_type::bfv && parms.scheme() != seal::scheme_type::bgv)
        {
        ...
        vector<seal::Ciphertext> product_vec;
        for (size_t i = 0; i < encrypteds.size() - 1; i += 2)
        {
            seal::Ciphertext temp(context_, context_data.parms_id(), pool);
    ...
    void Evaluator::exponentiate_inplace(
        seal::Ciphertext &encrypted, uint64_t exponent, const seal::RelinKeys &relin_keys, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        auto context_data_ptr = context_.get_context_data(encrypted.parms_id());
        if (!context_data_ptr)
        ...
        vector<seal::Ciphertext> exp_vector(static_cast<size_t>(exponent), encrypted);
        multiply_many(exp_vector, relin_keys, encrypted, std::move(pool));
    }

    void Evaluator::add_plain_inplace(seal::Ciphertext &encrypted, const seal::Plaintext &plain, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        if (!is_metadata_valid_for(encrypted, context_) || !is_buffer_valid(encrypted))
        {
        ...
        else if (parms.scheme() == seal::scheme_type::ckks)
        {
            if (!encrypted.is_ntt_form())
            {
                throw invalid_argument("CKKS encrypted must be in NTT form");
        ...
        else if (parms.scheme() == seal::scheme_type::bgv)
        {
            if (!encrypted.is_ntt_form())
            {
                throw invalid_argument("BGV encrypted must be in NTT form");
    ...
    void Evaluator::sub_plain_inplace(seal::Ciphertext &encrypted, const seal::Plaintext &plain, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        if (!is_metadata_valid_for(encrypted, context_) || !is_buffer_valid(encrypted))
        {
    ...
    void Evaluator::multiply_plain_inplace(seal::Ciphertext &encrypted, const seal::Plaintext &plain, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        if (!is_metadata_valid_for(encrypted, context_) || !is_buffer_valid(encrypted))
        {
    ...
    void Evaluator::multiply_plain_normal(seal::Ciphertext &encrypted, const seal::Plaintext &plain, seal::MemoryPoolHandle pool) const
    {
        // Extract encryption parameters.
        auto &context_data = *context_.get_context_data(encrypted.parms_id());
        auto &parms = context_data.parms();
    ...
    void Evaluator::multiply_plain_ntt(seal::Ciphertext &encrypted_ntt, const seal::Plaintext &plain_ntt) const
    {
        // Verify parameters.
    ...
    void Evaluator::transform_to_ntt_inplace(seal::Plaintext &plain, seal::parms_id_type parms_id, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
    ...
    void Evaluator::transform_to_ntt_inplace(seal::Ciphertext &encrypted) const
    {
        // Verify parameters.
        if (!is_metadata_valid_for(encrypted, context_) || !is_buffer_valid(encrypted))
        {
    ...
    void Evaluator::transform_from_ntt_inplace(seal::Ciphertext &encrypted_ntt) const
    {
        // Verify parameters.
    ...
    void Evaluator::apply_galois_inplace(
        seal::Ciphertext &encrypted, uint32_t galois_elt, const seal::GaloisKeys &galois_keys, seal::MemoryPoolHandle pool) const
    {
        // Verify parameters.
        if (!is_metadata_valid_for(encrypted, context_) || !is_buffer_valid(encrypted))
        {
        ...
        else if (parms.scheme() == seal::scheme_type::ckks || parms.scheme() == seal::scheme_type::bgv)
        {
            // !!! DO NOT CHANGE EXECUTION ORDER!!!
        ...
        switch_key_inplace(
            encrypted, temp, static_cast<const seal::KSwitchKeys &>(galois_keys), seal::GaloisKeys::get_index(galois_elt), pool);
#ifdef SEAL_THROW_ON_TRANSPARENT_CIPHERTEXT
        // Transparent ciphertext output is not allowed.
        if (encrypted.is_transparent())
        {
    ...
    void Evaluator::switch_key_inplace(
        seal::Ciphertext &encrypted, ConstRNSIter target_iter, const seal::KSwitchKeys &kswitch_keys, size_t kswitch_keys_index,
        seal::MemoryPoolHandle pool) const
    {
        ...
        if (scheme == seal::scheme_type::bfv && encrypted.is_ntt_form())
        {
            throw invalid_argument("BFV encrypted cannot be in NTT form");
        }
        ...
        if (scheme == seal::scheme_type::bgv && !encrypted.is_ntt_form())
        {
            throw invalid_argument("BGV encrypted must be in NTT form");
        }
        ...
        if (scheme == seal::scheme_type::ckks || scheme == seal::scheme_type::bgv)
        {
        ...
        SEAL_ITERATE(iter(size_t(0)), rns_modulus_size, [&](auto I) {
            ...
            SEAL_ITERATE(iter(size_t(0)), decomp_modulus_size, [&](auto J) {
                ...
                if ((scheme == seal::scheme_type::ckks || scheme == seal::scheme_type::bgv) && (I == J))
                {
        ...
        SEAL_ITERATE(iter(encrypted, t_poly_prod_iter), key_component_count, [&](auto I) {
            if (scheme == seal::scheme_type::bgv)
            {
                const seal::Modulus &plain_modulus = parms.plain_modulus();
            ...
            else
            {
                ...
                SEAL_ITERATE(iter(I, key_modulus, key_ntt_tables, modswitch_factors), decomp_modulus_size, [&](auto J) {
                    ...
                    else if (scheme == seal::scheme_type::bfv)
                    {
