...
execute_process(
  COMMAND "/usr/bin/git" show-ref "e47e674cd09583ff0503f0f6defd6d23d8b718d3"
  WORKING_DIRECTORY "/home/PrivSphere/build/SEAL/thirdparty/zstd-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "e47e674cd09583ff0503f0f6defd6d23d8b718d3")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("e47e674cd09583ff0503f0f6defd6d23d8b718d3" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/e47e674cd09583ff0503f0f6defd6d23d8b718d3")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/PrivSphere/build/SEAL/thirdparty/zstd-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/PrivSphere/build/SEAL/thirdparty/zstd-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
